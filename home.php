...
// Inisialisasi variabel 'type_account'
$type_account = null;
...
// Jika tipe akun tidak ditemukan, redirect ke index.php
if ($type_account === null) {
    header("Location: index.php");
    exit();
}

// Set session 'loggedin' dan 'type_account' setelah menentukan tipe akun
